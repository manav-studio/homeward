...
export default class NativeApp extends React.Component {
  ...
  async componentWillMount() {
    await Font.loadAsync({
      ...
      'Gilroy-Medium': unpackAsset(require('./assets/fonts/Gilroy/Gilroy-Medium.ttf')),
      'Gilroy-Bold': unpackAsset(require('./assets/fonts/Gilroy/Gilroy-Bold.ttf')),
      'Gilroy-SemiBold': unpackAsset(require('./assets/fonts/Gilroy/Gilroy-SemiBold.ttf'))
    });
